<template>
  <div >
      <ins class="lxb-container" style="height: 230px; width: 140px; border: 0px none rgb(0, 0, 0);z-index:99999999999; position: fixed; display: block !important; top: 119.28px; left: 0px; background-image: url('/static/images/home/sanztu-mobile.png'); background-color: transparent;" id="LXB_CONTAINER">
        ...
        <input class="lxb-cb-input-btn" value="立即免费通话" type="button" style="left: 17px; top: 196px; width: 109px; height: 28px; border: 0px none rgb(0, 0, 0); color: rgb(38, 38, 38); font-size: 14px; font-weight: bold; z-index: 4; font-family: 微软雅黑; background-color: rgb(254, 225, 0);text-align:center;">
        <ins class="lxb-group-con" style="top: 192px; display: none;"></ins>
        <ins class="lxb-cb-tip" style="z-index: 2147483647; display: none;">
          <ins class="lxb-cb-tip-con"></ins>
          <ins class="lxb-cb-tip-arrow"></ins>
          <ins class="lxb-cb-tip-close">╳</ins>
        </ins>
      </ins>
  </div>
</template>
